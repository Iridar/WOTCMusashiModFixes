...
$builder = [BuildProject]::new("WOTCMusashiModFixes", $srcDirectory, $sdkPath, $gamePath)
$builder.IncludeSrc("$srcDirectory\CHL_SRC")
$builder.IncludeSrc("C:\Program Files (x86)\Steam\steamapps\workshop\content\268500\2133397762\Src")
